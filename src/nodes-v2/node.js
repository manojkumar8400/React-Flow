        ...
        ? handles
            ...
            .map((handle, idx) => {
              return (
                <div
                  key={idx}
                  className='text-variables'
                  style={{ top: `${handle.y_pos}%` }}
                >
                  {handle.name}
                </div>
              )
        ...
        {fields.map((field, index) => {
              ...
              <div key={index} className=''>
                <div className='node-field'>
                  {props.type === "checkbox" ? (
                    ...
                    <>
                      <label
                        htmlFor={`${id}-${index}-file`}
                        className='node-input-file'
                      >
                        <svg
          ...
          if (type === "button") {
            return (
              <div key={index} className=''>
                <div className='node-field'>
                  <button {...props} className='node-button'>
                    {" "}
                    {label}{" "}
                  </button>
                </div>
